...
createRandomEnemy = compileFinal preProcessfile "createRandomEnemy.sqf";
loadSquad = compileFinal preProcessfile "loadSquad.sqf";
ejectSquad = compileFinal preProcessfile "ejectSquad.sqf";
paradropSquad = compileFinal preProcessfile "paradropSquad.sqf";
...
isParaHeight = compileFinal preProcessfile "isParaHeight.sqf";
